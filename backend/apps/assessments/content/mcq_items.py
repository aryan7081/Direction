...
MCQ_ITEMS: List[Dict[str, Any]] = [
    ...
    _mcq(
        ...
        "You have ₹10,000 saved. A friend pitches a startup idea that could double your money — or lose it all. What do you do?",
        [
            ("🛡️ Put it all in a safe fixed deposit", {"personality_risk_taking": 1}),
            ("⚖️ Invest half, keep half safe", {"personality_risk_taking": 3}),
            ("🚀 Invest everything — high risk, high reward", {"personality_risk_taking": 5}),
            ("🤝 Invest and offer to help run the startup", {"personality_risk_taking": 4}),
        ],
        "risk_cautious",
    ),
